// Flight component with beautiful card design
...
export const FlightList = () => {
    ...
    const startSearch = async () => {
        ...
        const url = (import.meta.env.VITE_BASE_API_URL as string) + `/api/flights/search${urlPostfix}?origin=${origin}&destination=${destination}&departureDate=${departureDate}&isEventStream=${enableEventStream}&responsePerSupplier=${responsePerSupplier}`;
